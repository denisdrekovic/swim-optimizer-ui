              ...
              <div className="flex flex-col min-h-0">
                ...
                <div className="flex-shrink-0 pt-4">
                  ...
                  <button
                    onClick={handleOptimize}
                    disabled={running || enabledEvents.size === 0}
                    className="w-full py-2.5 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-[0_1px_3px_0_rgb(37_99_235_/_0.3)]"
                  >
                    {running ? (
                      <>
